        ...
        <div className={item.url_status == 1 ? "groupLink-inner" : ""}>
          {item.url_status == 1 &&
            item.old_url_db.map((singleItem: any, key: any) => (
              <div
                className="optimizerList-box d-flex align-item-center gap-3"
                key={key}
              >
                ...
                <div className="optimizerProduct-imgfeild flex-grow-1 d-flex align-item-center gap-3">
                  <div className="custom-input link-iconDropi flex-grow-1">
                    <span>
                      Current URL
                      <a
                        href={`${homeUrl}${item.old_url_db[key]}`}
                        target="_blank"
                      >
                        <Image
                    ...
                    <input
                      ...
                      value={`${homeUrl}${item.old_url_db[key]}`}
                      disabled
                    />
                  </div>
                  ...
                  <div className="custom-input flex-grow-1">
                    ...
                    <input
                      type="text"
                      className="form-control"
                      value={`${homeUrl}${item.new_url_db[key]}`}
                      disabled
                    />
                  </div>
                  ...
                  <div className="custom-input flex-grow-1">
                    ...
                    <input
                      type="text"
                      className="form-control"
                      value={`${homeUrl}${item.redirect_url_db[key]}`}
                      disabled
                    />
                  </div>
                </div>
                ...
                <div className="optimizerProduct-actionInfo d-flex align-item-center gap-3">
                  <button
                    type="button"
                    className="btn btn-default url-savedBtn btn-disable"
                  >
                    Saved
                  </button>
                </div>
            ...
            <div className="URLEditor-inputList">
              <div className="custom-input link-iconDropi flex-grow-1">
                <span>
                  Current URL
                  <a
                    href={`${homeUrl}${itemType == "category" ? item.url.path : itemType == "page" ? item.url : item.custom_url.url}`}
                    target="_blank"
                  >
                    <Image
                      src={`${basePath}/images/link-icon.svg`}
                ...
                <input
                  type="text"
                  className="form-control"
                  value={`${homeUrl}${itemType == "category" ? item.url.path : itemType == "page" ? item.url : item.custom_url.url}`}
                  disabled
                />
              </div>
              ...
              <div className="custom-input prefix-input flex-grow-1">
                ...
                />
                <div
                  className={`keyword-count ${homeUrl.length + newUrl.length > 48 && "red-text"}`}
                >
              ...
              <div className="custom-input prefix-input flex-grow-1">
                ...
                />
                <div
                  className={`keyword-count ${homeUrl.length + redirectUrl.length > 48 && "red-text"}`}
                >
            ...
            <div className="optimizerProduct-actionInfo d-flex align-item-center gap-2">
              {buttonLoading ? (
                ...
                <>
                  <button
                    type="button"
                    className={`btn btn-default ${item.url_status == 0 && "url-savedBtn"} ${(newUrl.length == 0 || buttonLoading) && "btn-disable"}`}
                    disabled={newUrl.length == 0 || buttonLoading}
                    onClick={updateUrlData}
                  >
                    Save
                  </button>
                  {item.url_status == 1 && (
