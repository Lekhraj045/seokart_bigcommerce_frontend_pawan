...
export default function Home() {
  ...
  const [sitelinkSearchStatus, setSitelinkSearchStatus] =
  ...
  const getRichSnippetsStatus = () => {
    Api("getRichSnippetsStatus").then(({ data }) => {
      ...
      setBreadcrumbStatus(
        data.status.breadcrumb_status === "true" ? true : false,
      );
      setSitelinkSearchStatus(
        data.status.sitelink_search_status === "true" ? true : false,
      );
  ...
  const getItemCountNdUrl = () => {
    Api("getItemCountNdUrl").then(({ data }) => {
      setProduct({
        ...
        url: data.product?.urls ?? [],
      });
      setCategory({
        count: data.category?.count ?? 0,
        url: data.category?.urls ?? [],
      });
  ...
  const updateAllData = (type: any = "") => {
    ...
    const homeObj = {
      ...
      home_image: {
        sngl_img: singleImageUrl,
        mltpl_img: Object.values(multiImageUrl),
      },
    ...
    Api("addRichSnnipetsScriptData", {
      ...
      product_status:
        type == "product" ? String(!productStatus) : String(productStatus),
      faq_data: JSON.stringify({
        faq_url: faqUrl,
        all_data: Object.values(faqs),
      }),
      ...
      blog_post_status:
        type == "blogPost" ? String(!blogPostStatus) : String(blogPostStatus),
      breadcrumb_status:
        type == "breadCrumb"
          ? String(!breadcrumbStatus)
          : String(breadcrumbStatus),
      sitelink_search_status:
        type == "sitelink"
          ? String(!sitelinkSearchStatus)
          : String(sitelinkSearchStatus),
    }).then((data) => {
  ...
  const getSnippetsAllData = () => {
    Api("getSnippetsAllData").then(({ data }) => {
      ...
      setPriceValid({
        value: product.pvu_days,
        duration: product.pvu_duration,
      });
      ...
      setPriceRange({
        min: Number(homePage.home_price_start),
        max: Number(homePage.home_price_end),
      });
    ...
    <>
      ...
      <Confirmation
        ...
        handleYes={() => {
          ...
          if (localStorage?.getItem("manage_service") == "1") {
            setSitelinkSearchStatus(
              (sitelinkSearchStatus) => !sitelinkSearchStatus,
            );
            toast.success("Information updated.");
          } else {
          ...
          <div className="richSnippets-Area">
            <Accordion defaultActiveKey={["0", "1"]}>
                        ...
                        <Tab
                          ...
                          title={
                            <>
                              Home Page{" "}
                              <div
                                className={`badge badge-${homeStatus ? "success" : "danger"}`}
                              >
                                {homeStatus ? 1 : 0}
                              </div>
                            </>
                              ...
                              {homeStatus ? (
                                <>
                                  <h4 className="green-text">
                                    Rich Snippet code is successfully installed!
                                  </h4>
                                  <p>
                                    The code is successfully installed on your
                                    home page. To check if the code is working
                                    fine, please click on below sample link:
                                  </p>
                                  <ul>
                                    <li>
                                      <p>
                                        <a
                                          href={`https://search.google.com/test/rich-results?url=${homeUrl}`}
                                          target="_blank"
                                        >
                                          {homeUrl}
                                        </a>
                                  ...
                                  <p>
                                    If you find any issues, you can turn the
                                    code OFF and inform our support team via
                                    chat.
                                  </p>
                                </>
                              ) : (
                                <>
                                  <h4 className="red-text">
                                    Rich Snippet code is not installed!
                                  </h4>
                                  <p>
                                    To install it, please scroll below to the
                                    Home Page/Categories/Pages section, and put
                                    it ON. Once ON, the SEOKart app will place
                                    the code on your website for the below rich
                                    snippets:
                                  </p>
                                  <ul>
                                    <li>
                                      <p>
                                        Local Business Snippet (Business Name,
                                        Website, Description, Address, Contact
                                        Details, Social Media Profiles, Price
                                        Range)
                                      </p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <p>
                                        SiteLinks Search Snippet on Home Page
                                      </p>
                                    </li>
                                    <li>
                                      <p>
                                        Breadcrumbs Snippet on the Whole Website
                                      </p>
                                    </li>
                                    <li>
                                      <p>
                                        Article Snippet on All the Blog Posts
                                      </p>
                                    </li>
                                  </ul>
                                  <p className="red-text">
                                    Please note that once you place our code, it
                                    will disable any similar codes placed by
                                    other Apps.
                                  </p>
                                </>
                              )}
                        ...
                        <Tab
                          ...
                          title={
                            <>
                              Products{" "}
                              <div
                                className={`badge badge-${productStatus ? "success" : "danger"}`}
                              >
                                {productStatus ? product.count : 0}
                              </div>
                            </>
                          }
                        >
                            ...
                            <div className="consoleTab-box">
                              {productStatus ? (
                                <>
                                  ...
                                  <ul>
                                    {product.url.map((item, key) => (
                                      <li key={key}>
                                        <p>
                                          <a
                                            href={`https://search.google.com/test/rich-results?url=${homeUrl}${item}`}
                                            target="_blank"
                                          >
                                            {homeUrl}
                                            {item}
                                  ...
                                  <p>
                                    If you find any issues, you can put the code
                                    OFF and inform our support team via Chat.
                                  </p>
                                </>
                              ) : (
                                <>
                                  ...
                                  <p>
                                    To install it, please scroll below to the
                                    Products section, and put it ON. Once ON,
                                    the SEOKart app will place the code on your
                                    website for the below rich snippets:
                                  </p>
                                  <ul>
                                    <li>
                        ...
                        <Tab
                          ...
                          title={
                            <>
                              Blog Post{" "}
                              <div
                                className={`badge badge-${blogPostStatus ? "success" : "danger"}`}
                              >
                                {blogPostStatus ? blog.count : 0}
                              </div>
                            </>
                          }
                        >
                            ...
                            <div className="consoleTab-box">
                              {blogPostStatus ? (
                                <>
                                  ...
                                  <p>
                                    The code is successfully installed on your
                                    Blog Posts. To check if the code is working
                                    fine, please click on below sample links:
                                  </p>
                                  <ul>
                                ...
                                <>
                                  ...
                                  <p>
                                    To install it, please scroll below to the
                                    Home Page/Categories/Others section, and put
                                    it ON. Once ON, the SEOKart app will place
                                    the code on your website for the below rich
                                    snippets:
                                  </p>
                        ...
                        <Tab
                          ...
                          title={
                            <>
                              Categories{" "}
                              <div
                                className={`badge badge-${breadcrumbStatus ? "success" : "danger"}`}
                              >
                                {breadcrumbStatus ? category.count : 0}
                              </div>
                            </>
                          }
                        >
                            ...
                            <div className="consoleTab-box">
                              {breadcrumbStatus ? (
                                <>
                                  ...
                                  <p>
                                    The code is successfully installed on your
                                    Categories . To check if the code is working
                                    fine, please click on below sample links:
                                  </p>
                                  <ul>
                          ...
                          title={
                            <>
                              ...
                              <div
                                className={`badge badge-${breadcrumbStatus ? "success" : "danger"}`}
                              >
                                {breadcrumbStatus ? brand.count : 0}
                              </div>
                            </>
                          }
                        >
                            ...
                            <div className="consoleTab-box">
                              {breadcrumbStatus ? (
                                <>
                                  ...
                                  <p>
                                    The code is successfully installed on your
                                    Collections. To check if the code is working
                                    fine, please click on below sample links:
                                  </p>
                                  <ul>
                            ...
                            <div className="consoleTab-box">
                              {breadcrumbStatus ? (
                                ...
                                <>
                                  ...
                                  <p>
                                    You can also scroll below to FAQ section and
                                    put FAQ snippet on FAQ or any other Page.
                                  </p>
                                  <p className="red-text">
                                    Please note that once you place our code, it
                                    will disable any similar codes placed by
                    ...
                    <div className="richSnippets-productArea">
                      <div className="richSnippets-productBox">
                        <div className="richSnippets-productLeft">
                          ...
                          <p>
                            Please select the app your store is using to get
                            customer reviews.
                          </p>
                        </div>
                        ...
                        <div className="richSnippets-productRight">
                          <div className="autoSearch-dropi snippets-businessBox">
                            ...
                            <Select
                              value={reviewAppJson.data.find(
                                (item: any) => item.value == reviewApp,
                              )}
                              onChange={(selectedValue: any) =>
                                setReviewApp(selectedValue.value)
                              }
                      ...
                      <div className="richSnippets-productBox">
                        <div className="richSnippets-productLeft">
                          ...
                          <p>
                            Enter the Brand Name you want the app to use when no
                            Brand Name is available for a product.
                          </p>
                        </div>
                      ...
                      <div className="richSnippets-productBox">
                        <div className="richSnippets-productLeft">
                          ...
                          <p>
                            Please select a default value to tell Google how
                            long your product prices are valid. By default, we
                            have set it to 3 months.
                          </p>
                        </div>
                        ...
                        <div className="richSnippets-productRight price-valid-until">
                          <div className="headChannel-dropi custom-dropi big-dropi snippets-businessBox">
                            <div className="autoSearch-dropi snippets-businessBox">
                              ...
                              <Select
                                value={PriceValidJson.data.find(
                                  (item: any) => item.value == priceValid.value,
                                )}
                                onChange={(selectedValue: any) =>
                                  setPriceValid((oldValue) => ({
                                    ...oldValue,
                          ...
                          <div className="headChannel-dropi custom-dropi big-dropi snippets-businessBox">
                            <div className="autoSearch-dropi snippets-businessBox">
                              ...
                              <Select
                                value={PriceValidJson.data1.find(
                                  (item: any) =>
                                    item.value == priceValid.duration,
                                )}
                                onChange={(selectedValue: any) =>
                                  setPriceValid((oldValue) => ({
                                    ...oldValue,
                                    duration: selectedValue.value,
                                  }))
                                }
                  ...
                  <div className="richSnippets-productArea">
                    ...
                    <div className="richSnippets-productBox">
                      ...
                      <div className="richSnippets-productRight snippets-businessType">
                        <div className="autoSearch-dropi snippets-businessBox">
                          ...
                          <Select
                            value={businessTypeJson.business.find(
                              (item: any) => item.value == businessType,
                            )}
                            onChange={(selectedValue: any) =>
                              setBusinessType(selectedValue.value)
                            }
                        ...
                        {Object.keys(multiImageUrl).map((key: any) => (
                          <div
                            className="custom-input big-input snippets-businessBox snippets-addImage-box"
                            key={key}
                          >
                            <span>Enter Image URL</span>
                            <input
                              type="text"
                              className="form-control"
                              value={multiImageUrl[key].img_url}
                              onChange={(event) => {
                                setMultiImageUrl((multiImageUrl: any) => ({
                                  ...multiImageUrl,
                                  [key]: { img_url: event.target.value },
                                }));
                              }}
                            />
                            <button
                              type="button"
                              className="snippets-imageClose"
                              onClick={() => {
                                setMultiImageUrl((multiImageUrl: any) => {
                        ...
                        <div className="text-align-left">
                          <button
                            ...
                            onClick={() => {
                              setMultiImageUrl((multiImageUrl: any) => ({
                                ...multiImageUrl,
                                [Object.keys(multiImageUrl).length + 1]: {
                                  img_url: "",
                                },
                              }));
                            }}
                      ...
                      <div className="richSnippets-productRight snippets-businessType">
                        <div className="custom-input big-input icon-input snippets-businessBox">
                          ...
                          <i className="input-icon">
                            <Image
                              src={`${basePath}/images/facebook-icon.svg`}
                              width={14}
                              height={14}
                              alt=""
                            />
                        ...
                        <div className="custom-input big-input icon-input snippets-businessBox">
                          ...
                          <i className="input-icon">
                            <Image
                              src={`${basePath}/images/twitter-icon.svg`}
                              width={14}
                              height={14}
                              alt=""
                            />
                        ...
                        <div className="custom-input big-input icon-input snippets-businessBox">
                          ...
                          <i className="input-icon">
                            <Image
                              src={`${basePath}/images/instagram-icon.svg`}
                              width={14}
                              height={14}
                              alt=""
                            />
                        ...
                        <div className="custom-input big-input icon-input snippets-businessBox">
                          ...
                          <i className="input-icon">
                            <Image
                              src={`${basePath}/images/youtube-icon.svg`}
                              width={14}
                              height={14}
                              alt=""
                            />
                        ...
                        <div className="custom-input big-input icon-input snippets-businessBox">
                          ...
                          <i className="input-icon">
                            <Image
                              src={`${basePath}/images/linkedin-icon.svg`}
                              width={14}
                              height={14}
                              alt=""
                            />
                        ...
                        <div className="custom-input big-input icon-input snippets-businessBox">
                          ...
                          <i className="input-icon">
                            <Image
                              src={`${basePath}/images/snapchat-icon.svg`}
                              width={14}
                              height={14}
                              alt=""
                            />
                          ...
                          <input
                            type="text"
                            placeholder="Enter Richsnippet Username"
                            className="form-control"
                            value={snapchatUrl}
                            onChange={(event) => {
                        ...
                        <div className="custom-input big-input icon-input snippets-businessBox">
                          ...
                          <i className="input-icon">
                            <Image
                              src={`${basePath}/images/pinterest-icon.svg`}
                              width={14}
                              height={14}
                              alt=""
                            />
                    ...
                    <div className="richSnippets-productBox">
                      <div className="richSnippets-productLeft">
                        <h3>Price Range</h3>
                        <p>
                          Please select the price range of the products you sell
                          in your store.
                        </p>
                      </div>
                      ...
                      <div className="richSnippets-productRight snippetsRange-area">
                        ...
                        <div className="snippetsMinMax-area">
                          <div className="scippets-rangeMin">
                            Min: {currency}
                            {priceRange.min.toLocaleString()}
                          </div>
                          <div className="scippets-rangeMax">
                            Max: {currency}
                    ...
                    <div className="richSnippets-productBox snippets-fullBox">
                      <div className="richSnippets-productLeft">
                        ...
                        <p>
                          This will add an Article snippet to the listing of all
                          the blog posts on your website on Google. It can
                          enhance the appearance of your blog posts in Google
                          Search results.
                        </p>
                      </div>
                    </div>
              ...
              <Accordion.Item eventKey="3">
                <Accordion.Header> FAQs Page</Accordion.Header>
                <div className="vc-toggle-container">
                  <label className="vc-small-switch">
                    <input
                      type="checkbox"
                      ...
                      onChange={() => {
                        if (faqUrl.trim() == "") {
                          toast.error(
                            "Please enter the URL of the page where you want to install the FAQ Snippet.",
                          );
                          return false;
                        }
                      ...
                      <div className="richSnippets-productRight">
                        ...
                        {Object.keys(faqs).map((key) => (
                          <div className="snippetsAdd-faqBox" key={key}>
                            <button
                              type="button"
                              className="snippetsFaq-closeBtn"
                              onClick={() => {
                                setFaqs((faqs: any) => {
                            ...
                            <div className="custom-input big-input snippets-businessBox">
                              ...
                              <input
                                ...
                                className="form-control"
                                value={faqs[key].faq_question}
                                onChange={(event) => {
                                  setFaqs((faqs: any) => ({
                                    ...faqs,
                                    [key]: {
                                      ...faqs[key],
                                      faq_question: event.target.value,
                                    },
                                  }));
                                }}
                              />
                            ...
                            <div className="custom-input big-input snippets-businessBox">
                              ...
                              <input
                                ...
                                className="form-control"
                                value={faqs[key].faq_answer}
                                onChange={(event) => {
                                  setFaqs((faqs: any) => ({
                                    ...faqs,
                                    [key]: {
                                      ...faqs[key],
                                      faq_answer: event.target.value,
                                    },
                                  }));
                                }}
                              />
                        ...
                        <div className="text-align-left">
                          <button
                            type="button"
                            className="custom-btn mb-22"
                            onClick={() => {
                              setFaqs((faqs: any) => ({
                                ...faqs,
                                [Object.keys(faqs).length + 1]: {
                                  faq_question: "",
                                  faq_answer: "",
                                },
                              }));
